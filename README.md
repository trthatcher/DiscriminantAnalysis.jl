...
underlying data follows a multivariate normal distribution. DA is distinct from
...
## Linear Discriminant Analysis - Getting Started

## Quadratic Discriminant Analysis - Getting Started
